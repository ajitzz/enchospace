...
import { Shield, Trash2, Edit, Plus, Users, Home, CreditCard, TrendingUp, Calendar, MapPin, DollarSign, Activity, Search as SearchIcon } from 'lucide-react';
                      ...
                      <tbody>
                        {filteredBookings.map((booking: any) => (
                          <tr key={booking.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                            ...
                            <td className="py-4 px-6 text-right text-xs text-gray-400">-</td>
                          </tr>
                        ))}

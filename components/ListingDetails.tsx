  ...
  const handleBookingAction = () => {
      ...
      if (bookingStep === 'AVAILABILITY') {
          ...
          if (availability.status === 'SOLD_OUT') {
              // Now we allow proceeding but maybe warn, or just re-verify? 
              // User request was to allow editing. 
              // Let's assume if they click reserve on a sold out item, we block it here.
              // But since we removed the disable UI, user can select it.
                ...
                <div className="mb-10 pt-4 pb-8 border-t border-gray-200">
                    <h2 className="text-xl font-bold text-gray-900 mb-6">Where you’ll be</h2>
                     <div className="relative w-full h-64 md:h-80 bg-gray-100 rounded-2xl overflow-hidden shadow-sm group">
                        <img 
                            src="https://cartodb-basemaps-a.global.ssl.fastly.net/rastertiles/voyager/15/17600/10748.png" 
                            alt="Map location" 
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
                        />
                         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                             <div className="w-12 h-12 bg-[#E31C5F]/20 rounded-full flex items-center justify-center animate-pulse">
                                 <div className="w-4 h-4 bg-[#E31C5F] rounded-full shadow-lg ring-4 ring-white"></div>
                             </div>
                         </div>

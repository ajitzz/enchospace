          ...
          <div ref={desktopMenuRef} className="relative hidden md:block">
            ...
            {isDesktopMenuOpen && (
                <div className="absolute right-0 top-full mt-3 w-72 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)] border border-gray-100 overflow-hidden animate-fade-in-up origin-top-right z-50">
                    ...
                    <div className="p-2 border-b border-gray-100">
                         <div onClick={onHostClick} className="p-3 font-medium text-gray-700 hover:bg-gray-50 rounded-xl cursor-pointer">Host your space</div>
                         <div onClick={onAdminClick} className="p-3 font-medium text-gray-700 hover:bg-gray-50 rounded-xl cursor-pointer">Admin Control</div>

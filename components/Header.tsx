          ...
          <div ref={desktopMenuRef} className="relative hidden md:block">
            ...
            {isDesktopMenuOpen && (
                <div className="absolute right-0 top-full mt-3 w-72 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)] border border-gray-100 overflow-hidden animate-fade-in-up origin-top-right z-50">
                    ...
                    <div className="p-2 border-b border-gray-100">
                         <div onClick={() => { onHostSpaceClick(); setIsDesktopMenuOpen(false); }} className="p-3 font-medium text-gray-700 hover:bg-gray-50 rounded-xl cursor-pointer">Host your space</div>
          ...
          <div className="fixed inset-0 z-[100] md:hidden">
              ...
              <div className="absolute right-0 top-0 bottom-0 w-[85%] max-w-[360px] bg-white shadow-2xl animate-slide-in-right flex flex-col">
                  ...
                  <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-8">
                      ...
                      {/* Hero: Become a Host */}
                      <div onClick={() => { onHostSpaceClick(); setIsMobileMenuOpen(false); }} className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#E31C5F] to-orange-500 text-white p-6 shadow-lg active:scale-[0.98] transition-transform cursor-pointer">
